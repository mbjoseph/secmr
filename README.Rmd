...
> Joseph MB, Knapp RA, (2020). _`r Title`_. bioRxiv, Online at <https://doi.org/xxx/xxx>
...
> Joseph MB, Knapp RA, (`r format(Sys.Date(), "%Y")`). _Compendium of R code and data for `r Title`_. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://doi.org/xxx/xxx>
